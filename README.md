# FastOctreeTraversal
Implementation of an Octree and Efficient octree traversal algorithm for the offline raytrace renderer. Renderer used was proprietary, therefore only my octree class and algorithm are provided. 
